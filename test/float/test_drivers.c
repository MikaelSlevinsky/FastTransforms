...
int main(int argc, const char * argv[]) {
    ...
    //float alpha = -0.5, beta = -0.5, gamma = -0.5; // best case scenario
    float alpha = 0.0, beta = 0.0, gamma = 0.0; // not as good. perhaps better to transform to second kind Chebyshev
