...
int main(void) {
    ...
    printf("\n");
    printf("\t"MAGENTA"[P₄(z⋅y) - P₄(x⋅y)]/(z⋅y - x⋅y)"RESET",\n");
    printf("\n");
    printf("is actually a degree-3 polynomial on "MAGENTA"𝕊²"RESET", where "MAGENTA"P₄"RESET" is the degree-4\n");
    printf("Legendre polynomial, and "MAGENTA"x,y,z ∈ 𝕊²"RESET".\n");
    printf("To verify, we sample the function on an "MAGENTA"N×M"RESET" tensor product grid\n");
    printf("at equispaced points-in-angle defined by:\n");
    printf("\n");
    printf("\t"MAGENTA"θₙ = (n+1/2)π/N"RESET", for "MAGENTA"0 ≤ n < N"RESET",\n");
    printf("\n");
    printf("and\n");
    printf("\n");
    printf("\t"MAGENTA"φₘ = 2π m/M"RESET", for "MAGENTA"0 ≤ m < M"RESET";\n");
    printf("\n");
    printf("we convert the function samples to Fourier coefficients using\n");
    printf(CYAN"ft_plan_sph_analysis"RESET" and "CYAN"ft_execute_sph_analysis"RESET"; and finally, we transform\n");
    printf("the Fourier coefficients to spherical harmonic coefficients using\n");
    printf(CYAN"ft_plan_sph2fourier"RESET" and "CYAN"ft_execute_fourier2sph"RESET".\n");
    printf("\n");
    printf("In the basis of spherical harmonics, it is plain to see the\n");
    printf("addition theorem in action, since "MAGENTA"P₄(x⋅y)"RESET" should only consist of\n");
    ...
    printmat("Colatitudinal grid "MAGENTA"θ"RESET, FMT, theta, N, 1);
    printf("\n");
    printmat("Longitudinal grid "MAGENTA"φ"RESET, FMT, phi, 1, M);
    printf("\n");

    printf("Arbitrarily, we place "MAGENTA"x"RESET" at the North pole: "MAGENTA"x = (%1.3f,%1.3f,%1.3f)ᵀ"RESET".\n\n",x[0],x[1],x[2]);
    printf("Another vector is completely free: "MAGENTA"y = (%1.3f,%1.3f,%1.3f)ᵀ"RESET".\n\n",y[0],y[1],y[2]);
    printf("Thus "MAGENTA"z ∈ 𝕊²"RESET" is our variable vector.\n\n");
    ...
    printf("Similarly, on the tensor product grid, the Legendre polynomial "MAGENTA"P₄(z⋅y)"RESET" is:\n\n");
    ...
    printf("Finally, the Legendre polynomial "MAGENTA"P₄(z⋅x)"RESET" is aligned with the grid:\n\n");
    ...
    printf("That nonnegligible coefficient should be approximately "MAGENTA"√(2π/(4+1/2))"RESET",\n");
